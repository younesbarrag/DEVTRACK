                    ...
                    <form action="{{ route('projects.update', $project) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" 
                                   ...
                                   placeholder="Enter project name" value="{{ old('title', $project->title) }}">
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="5" 
                                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('description', $project->description) }}</textarea>
                        </div>
